...
description: Analyzes your recent AI chat history to identify coding patterns, development gaps, and areas for improvement, curates relevant learning resources from HackerNews, and automatically sends a personalized growth report to your Slack DMs.
---

# Developer Growth Analysis

This skill provides personalized feedback on your recent coding work by analyzing your AI chat interactions and identifying patterns that reveal strengths and areas for growth.
...
1. **Reads Your Chat History**: Accesses your local AI chat history from the past 24-48 hours to understand what you've been working on.
...
1. **Access Chat History**
   ...
   Read the chat history from history (i.e. `~/.claude/history.jsonl`). This file is a JSONL or similar format where each line contains:
